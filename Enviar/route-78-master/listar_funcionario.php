	...
	if($qtd > 0){
		...
		while($row = $result->fetch_assoc()){	
			...
			print "<td>
					...
					<button class='btn btn-success' onclick=\"location.href='index2.php?page=edit_funcionario&cod_fun=".$row["codigo_funcionario"]."';\"><i class='fa fa-edit'></i></button>
					
					<button class='btn btn-danger' onclick=\"location.href='index2.php?page=salvar_funcionario&acao=excluir&cod_fun=".$row["codigo_funcionario"]."';\"><i class='fa fa-trash'></i></button>
